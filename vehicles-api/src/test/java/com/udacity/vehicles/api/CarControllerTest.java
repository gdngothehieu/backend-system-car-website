...
public class CarControllerTest {
    ...
    public void listCars() throws Exception {
        ...
        String carJson = responseJson.getJSONObject("_embedded").getJSONArray("carList").get(0).toString();
        Car actualCar = new ObjectMapper().readValue(carJson, Car.class);
        Car expectedCar = getCar();
        expectedCar.setId(1L);
        Assert.assertEquals(expectedCar.getId(), actualCar.getId());
        Assert.assertEquals(expectedCar.getCreatedAt(), actualCar.getCreatedAt());
    ...
    public void findCar() throws Exception {
        ...
        expectedCar.setId(1L);
        MvcResult result = mvc.perform(
                get(new URI(("/cars/" + expectedCar.getId())))
                        .contentType(MediaType.APPLICATION_JSON_UTF8)
                        .accept(MediaType.APPLICATION_JSON_UTF8))
                .andExpect(status().isOk()).andReturn();
    ...
    public void deleteCar() throws Exception {
        ...
        //perform delete and verify no content(204) is returned
        mvc.perform(delete(new URI("/cars/"+expectedCar.getId()))
        .accept(MediaType.APPLICATION_JSON_UTF8)
        .contentType(MediaType.APPLICATION_JSON_UTF8))
